      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-h-[100px] flex flex-col">
          ...
          <div className="mt-auto flex justify-between items-center">
            <span className="text-sm text-gray-500">ID : {todo.userId}</span>
            <span className={`text-sm px-2 py-1 rounded ${todo.completed ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}>{todo.completed ? "완료!" : "진행 중"}</span>
          </div>
        </div>
      </div>
    </div>
